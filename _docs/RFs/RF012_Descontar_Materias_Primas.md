...
**Vínculo receta ↔ producto terminado**: el formulario de recetas exige el selector "Producto terminado" (`product_id`, obligatorio desde RN-045) con creación inline del producto; al completar una orden, el rendimiento se suma al stock de ese producto y aparece en Productos terminados. Si la receta no tiene producto asociado, el diálogo de confirmación lo advierte explícitamente y el stock de productos no se modifica.
